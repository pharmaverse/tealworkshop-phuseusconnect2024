# Rerun the teal app for cdisc data again and click at the Show R Code.
# You should see this: warning('Code was not verified for reproducibility.')
# 
# Let's learn verify()
# ?verify
# 
# There's also a vignette: https://insightsengineering.github.io/teal.data/latest-tag/articles/teal-data-reproducibility.html
# 
# Let's fix the app one more time:
